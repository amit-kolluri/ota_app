...
<body>
	<div class="container">
		<%@include file="../landing/header-landing.jsp" %>
		<main class="content">
		...
		<div class="ota-main_login">
			...
			<form:form action="./processRegistration.htm" method="post"
				...
				<h3 class="registrationform_error">${errMsg}</h3>
				<div class="registration_table">
					<table class="table_content">
						...
						<tr>
							<td class="table_content-tdone"><form:select path="batchId" id="batchId"
									class="table_input">
									<option value="0" disabled="disabled" selected="selected"
										hidden="hidden">Select a batch</option>
									<c:forEach items="${batchList}" var="batch">
										<form:option path="batchId" value="${batch.id}">${batch.name}</form:option>
									</c:forEach>
								</form:select> <form:errors element="div" class="registereduser_error"
									path="batchId" /></td>
						</tr>
						<tr>
							<td><p>Email:</p><form:input class="table_input" path="email" id="email"
									placeholder="" /> <form:errors element="div"
									class="registereduser_error" path="email" /></td>
						</tr>
						<tr>
							<td><p>Password:</p><form:password class="table_input" path="password"
									id="password" placeholder="" /> <form:errors
									element="div" class="registereduser_error" path="password" /></td>
						</tr>
						<tr>
