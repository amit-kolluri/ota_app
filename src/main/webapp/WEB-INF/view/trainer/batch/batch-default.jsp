...
<link rel="stylesheet" href="/static/css/trainer/batch/batch-default.css">
</head>
<body>
    <div class="container">
        ...
        <div class="ota-main_container">
                ...
                &nbsp;
                    ...
                    <table id="example" class="head">
                            <tr>				
                            <td class="wrap-td">Batch Name</td>
                            <td class="wrap-td">Number of Trainees</td>
                            <td class="wrap-td">Activate/Deactivate</td>
                            <td class="wrap-td">Edit</td>
                        ...
                        <div class="inner_table">
                            <table id="test-table">
                            <tbody>
                            <c:forEach items="${namesList}" var="name" varStatus="loop">
         			<tr class="table__row--border">
         				
						<td class="table__data"><a href="/trainer/batch/${idList[loop.index]}/details.htm">${name}</a></td>
						<td class="table__data">${numUsers[loop.index]}</td>
						<c:choose>
  							<c:when test="${statusList[loop.index]==1}">
								<td class="table__data"><a href="/trainer/batch/${idList[loop.index]}/changeStatus.htm"><button class="button button--state-deactivate">Deactivate</button></a></td>
								<td class="table__data"><a href="/trainer/batch/${idList[loop.index]}/edit.htm">Edit Batch</a></td>
								<td class="table__data">Active</td>				
  							</c:when>
  							<c:otherwise>
						   		<td class="table__data"><a href="/trainer/batch/${idList[loop.index]}/changeStatus.htm"><button class="button button--state-activate">Activate</button></a></td>
								<td class="table__data"><a href="/trainer/batch/${idList[loop.index]}/edit.htm">Edit Batch</a></td>
