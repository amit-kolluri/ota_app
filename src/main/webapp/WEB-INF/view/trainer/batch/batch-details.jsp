                ...
                <div class="ota-main_container">
                    ...
                    <div class="chart">
                        <div class="chart-block">
                            <p class="chart-block_title">Batch Name: </p>
                            <p class="chart-block_value">${batch.name}
                            </p>
                        </div>

                        <div class="chart-block">
                            <p class="chart-block_title">Number of Trainees: </p>
                            <p class="chart-block_value">${fn:length(traineesList)}</p>
                        </div>

                        <div class="chart-block">
                            <p class="chart-block_title">Status: </p>
                            <p class="chart-block_value">
                                <c:if test="${batch.statusId == 1}">
                                    Active
                                </c:if>
                    ...
                    <div class="wrap">
                        <table id="example" class="head">
                            <tr>
                                ...
                                <td class="wrap-td">Phone Number</td>
                        ...
                        <div class="inner_table">
                            <table id="test-table">
                                <tbody>
                                <c:forEach items="${traineesList}" var="user">
                                    <tr>
                                        <td>
                                            <a href="/trainer/trainee/${user.id}/details.htm">
                                                    ${user.firstName} ${user.lastName} </a>
                                        </td>
                                        <td><a href="mailto: ${user.email}"> ${user.email} </a></td>
                                        <td><a href="tel: ${user.phoneNumber}">
                                                ${user.phoneNumber} </a></td>
                                        <td><c:if test="${user.statusId == 1}">
                                            Active
                                        </c:if> <c:if test="${user.statusId == 2}">
                                            Inactive
                                        </c:if></td>
                                        <td>
                                            <a href="/trainer/batch/${user.id}/edit-trainee-details.htm">
                                                <button class="inner_table-button inner_table-button-edit">Edit</button>
                                            </a>
                                            <a href="delete-batch.html">
                                                <button class="inner_table-button inner_table-button-delete">Delete
                                                </button>
                                            </a>
                                        </td>
                                    </tr>
