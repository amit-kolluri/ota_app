...
<body>
	<div class="container">
		...
		<div class="content">
			...
			<div class="ota-main_container" style="overflow: auto;">
				<div class="label_top">
					<label class="label_top_test">Test Name</label> <label
						class="label_top_duration">Duration</label>
					<hr class="top_hr">
				</div>
				<form class="edit-test-form" action="./update.htm" method="post"
					ModelAttribute="command">
					<input class="middle_content_box1" type="text" name="topic_name"
						value="${topicName}" /> <input class="middle_content_button"
						type="submit" value="edit" />
				</form>
				<form class="edit-test-form" action="./editTime.htm"
					method="post" ModelAttribute="command">
					<input class="middle_content_box2" type="text" name="timeAlloted"
						value="${duration}" /> <input class="middle_content_button"
						type="submit" value="edit" />
				</form>
				<hr class="middle_hr">
				<div class="wrap">
