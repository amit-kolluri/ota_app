                    ...
                    <c:forEach items="${traineeList}" var="trainee">
                        ...
                        <tr class="table__row--border">
                            <td class="table__data table__data--padding--trainee-default">
                                <a class="link--trainee-default" href="/trainer/${trainee.id}/details.htm">${trainee.firstName} ${trainee.lastName}</a>
                            </td>
                            <td class="table__data table__data--padding--trainee-default">
                                ${batchName}
                            </td>
                            ...
                            <td style="white-space:nowrap;" class="table__data table__data--padding--trainee-default">
                                <a class="link--trainee-default" href="/trainer/trainee/${trainee.id}/edit-trainee-details.htm">Edit</a>&nbsp;|&nbsp;
                                <a onclick="return confirm('Delete account and data for ${trainee.firstName} ${trainee.lastName}?')" class="link--trainee-default, delete--trainee-default" href="/trainer/trainee/${trainee.id}/delete.htm">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
