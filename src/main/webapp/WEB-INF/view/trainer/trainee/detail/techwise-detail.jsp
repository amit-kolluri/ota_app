                    ...
                    <div class="wrap">
                        <table id="example" class="head">
                            <tr>
                                ...
                                <td class="wrap-td">Answer Chosen</td>
                        ...
                        <div class="inner_table">
                            ...
                            <c:forEach items="${resultDetails}" var="resultDetails">
                                    <tr>
                                    	<td>${count}</td>
                                        <td>${resultDetails.question}</td>
                                        <td>${resultDetails.option1}</td>
                                        <td>${resultDetails.option2}</td>
                                        <td>${resultDetails.option3}</td>
                                        <td>${resultDetails.option4}</td>
                                        <td>${resultDetails.userAnswer}</td>
                                        <td>${resultDetails.correctAnswer}</td>
