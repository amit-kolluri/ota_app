...
<html>
    <head>
        ...
        <title>Trainee Details for Trainer</title>
                    ...
                    <div class="row">
                        <div class="column" id="dashboard_dropdown-25percent">
                            <select name="technologies" id="technologies">
                                <option value="initial">Select A Technology</option>
                                <c:forEach items="${technologies}" var="technology">
                                    <option value="/trainer/trainee/${traineeId}/${technology.id}/tests.htm">${technology.name}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <script type="text/javascript">
                            ...
                            // series2.fill = am4core.color("#F70000");
